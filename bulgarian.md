...
> Ролевите модели са важни. <br>
> -- Офицер Алекс Мърфи / Робокоп

Едно нещо, което винаги ме е дразнило като Руби разработчик - Пайтън
разработчиците имат великолепно ръководство за стил
([PEP-8][]), а ние никога не получихме официално ръководство, документиращо
стиловото оформление на Руби код и най-добри практики. И аз смятам, че
стилът има значение. Също така смятам, че велико общество хакери, което Руби
си има, би трябвало да може само да си напише такъв документ.

Това ръководство започна живота си с наши си вътрешни правила за писане на Руби код
във фирмата(написани от моя милост). В един момент реших, че работата, 
която правех, може да е интересна и на други членове на Руби общността, 
по принцип и като цяло, свeтът има малка нужда от други вътрешни фирмени правила.
Но светът със сигурност може да се възползва от едни общност задвижвани и санкционирани
набор от практики, идиоми и стил предписания за програмиране Руби.

Със започването на ръководството съм получавал много обратната връзка от членовете на
изключителното Руби общество из целия свят. Благодаря за всички предложения
и за подкрепата! Заедно можем да направим един ресурс за полза на всеки
Ruby разработчик по света.

По между другото, ако Ви влече Рейлс, може би искате да видите допълващия 
[Ruby on Rails Style Guide][rails-style-guide].

# Руби ръководство по стил

Това Руби ръководство по стил препоръчва най-добри практики, така че
в реалния свят, Руби програмисти да могат да пишат лесно-поддържащ се код от
други Руби програмисти. Ръководство по стил, което отразява използването в реалния
свят, бива използвано, и ръководство, което държи на идеал, отхвърлен от хората, на
които би трябвало да помога, рискува да не бъде използвано въобще - без значение
колко е добрo.

Ръководството е разделено на няколко секции от свързани правила. Опитах се да добавя
обосновка на правилата (ако това е пропуснато, съм предполагал, че е доста
oчевидно).

Не съм измислил всички тези правила от нищото - повечето са базирани
на обширната ми кариера като професионален софтуерен инженер,
обратна връзка и предложения от членове на Руби общността и
различни високо ценени програмни ресурси, като например
["Programming Ruby"][pickaxe] и 
["The Ruby Programming Language"][trpl].

Има някои области, в които обществото няма общ ясен консенсус
по отношение на определен стил(като цитирането на буквен низ, отстояние вътре в скоби
на хеш, точка позицията в многоредови методи и т.н.). При такива сценарии,
всички популярни стилове са признати, и това е до вас да си изберете един и да го
прилагате консистентно.

Това ръководство еволюира с течение на времето, като допълнителни конвенции са
идентифицирани и предишни конвенции се оказват отживели чрез промени в
самото Руби.

Много проекти имат свои собствени насоки за код (често получени
от настоящото ръководство). В случай на каквито и да било конфликти, като
проекто-специфични правила, те приемат предимсто за проекта.

Можете да генерирате PDF или HTML копие от това ръководство, като използвате
[Pandoc][].

[RuboCop][] е статичен анализатор на код, основаващ се на този стил.

Преводи на ръководството са на разположение и на следните езици:

* [Опростен китайски](https://github.com/JuanitoFatas/ruby-style-guide/blob/master/README-zhCN.md)
* [Традиционен китайски](https://github.com/JuanitoFatas/ruby-style-guide/blob/master/README-zhTW.md)
* [Френски](https://github.com/gauthier-delacroix/ruby-style-guide/blob/master/README-frFR.md)
* [Немски](https://github.com/arbox/de-ruby-style-guide/blob/master/README-deDE.md)
* [Японски](https://github.com/fortissimo1997/ruby-style-guide/blob/japanese/README.ja.md)
* [Корейски](https://github.com/dalzony/ruby-style-guide/blob/master/README-koKR.md)
* [Португалски](https://github.com/rubensmabueno/ruby-style-guide/blob/master/README-PT-BR.md)
* [Руски](https://github.com/arbox/ruby-style-guide/blob/master/README-ruRU.md)
* [Испански](https://github.com/alemohamad/ruby-style-guide/blob/master/README-esLA.md)
* [Виетнамски](https://github.com/scrum2b/ruby-style-guide/blob/master/README-viVN.md)

## Table of Contents

* [Изглед на Кода](#source-code-layout)
* [Синтаксис](#syntax)
* [Именоване](#naming)
* [Коментари](#comments)
  * [Анотация на коментарите](#comment-annotations)
* [Класове & Модули](#classes--modules)
* [Изключения](#exceptions)
* [Колекции](#collections)
* [Числа](#numbers)
* [Низове](#strings)
* [Регулярни изрази](#regular-expressions)
* [Процент литерали](#percent-literals)
* [Метапрограмиране](#metaprogramming)
* [Разнородни](#misc)
* [Инструменти](#tools)

## Изглед на Кода

> Почти всеки е убеден, че всеки стил, освен неговият си, е
> грозен и нечетлив. Махнете  ", освен неговият си" и те
> най-вероятно са прави ... <br>
> -- Джери Кофин (на идентацията)

* <a name="utf-8"></a>
  Използвайте `UTF-8` като изходното шифриране на кода.
<sup>[[link](#utf-8)]</sup>

* <a name="spaces-indentation"></a>
  Използвайте две **шпации** за ниво на идентация. Без тежки разделители.
...
* <a name="crlf"></a>
Използвайте Unix стил окончания на линиите. ( * BSD/Solaris/Linux/потребители OS X
са обхванати от подразбиране, потребителите на Windows трябва да бъдат 
особено внимателни.)
<sup>[[link](#crlf)]</sup>

  * Ако използвате Git може да искате да добавите следната
    конфигурируема настройка, за да защитите проекта си от Windows
    окончания на линията плъзващи вътре:
...
* <a name="no-semicolon"></a>
  Не използвайте `;` до отделни  изрази. Като следствие - използвайте един
  израз на ред.
<sup>[[link](#no-semicolon)]</sup>

  ```Ruby
  # лош
  puts 'foobar'; # излишна точка и запетая 

  puts 'foo'; puts 'bar' # два израза на един и същ ред
  ...
  puts 'foo', 'bar' # това се отнася само за "puts" метода
  ```

* <a name="single-line-classes"></a>
  Предпочитайте едноредов формат за дефиниране на клас без тяло.
...
* <a name="no-single-line-methods"></a>
  Избягвайте едноредови методи. Въпреки че са малко популярни в битието,
  има няколко особености за тяхното синтактично дефиниране, които правят тяхното
  използване нежелателно. Във всеки случай - не трябва да има повече от един израз в
  метод с единична линия.
<sup>[[link](#no-single-line-methods)]</sup>
  ...
  # ставащ - забележете, че първата ; е задължителна
  def no_braces_method; body end

  # ставащ - забележете, че втората ; е по избор
  def no_braces_method; body; end

  # ставащ - валиден синтаксис, но без ; 
  # okish - valid syntax, but no ; го прави малко трудно за четене
  ...
  Едно изключение от правилото са методи с празно тялото.
...
* <a name="spaces-operators"></a>
  Оставяйте пространство около оператори, след запетайки, запетая и точка и запетая.
  Празните шпации може би (най-вероятно) не влияят на Руби интерпретатора,
  но правилното им използване е ключ към писането лесно четим код.
<sup>[[link](#spaces-operators)]</sup>
  ...
  Единственото изключение, по отношение на операторите, е експоненциалния оператор:
...
* <a name="spaces-braces"></a>
  Без интервали след `(` , `[` или преди `]` , `)`.
  Използвайте празни места, около `{` и преди `}`.
<sup>[[link](#spaces-braces)]</sup>
  ...
  `{` и `}` заслужават малко уточнение, тъй като те се използват
  за блокове и хешове, както и низова интерполация.

  За хешове два стила, се считат за приемливи.
  Първият вариант е малко по-разбираем (и може би по-
  популярен в Руби общността като цяло). Вторият вариант има
  предимството, че добавя визуална разлика между блок и хеш.
  Което и да изберете - да се прилага последователно.

  ```Ruby
  # добър - интервал след { и преди }
  { one: 1, two: 2 }

  # добър - без интервал след { и преди }
  {one: 1, two: 2}
  ```

  With interpolated expressions, there should be no padded-spacing inside the braces.
  С интерполиращи изрази, не трябва да разстояние вътре в скобите.
...
* <a name="no-space-inside-range-literals"></a>
  Записвайте литерала за серии без интервали.
...
* <a name="indent-when-to-case"></a>
  ...
  Идентирайте `when` дълбоко колкото `case`. Това е стилът наложев и в
  "The Ruby Programming Language", и в "Programming Ruby".
...
* <a name="indent-conditional-assignment"></a>
  ...
  При възлагане на резултата на условен израз на променлива,
  запази обичайното подреждане на нейните клонове.
<sup>[[link](#indent-conditional-assignment)]</sup>
  ...
  # добър (и малко по-пестилово от към ширина)
  kind =
    case year
    when 1850..1889 then 'Blues'
    when 1890..1909 then 'Ragtime'
...
* <a name="empty-lines-between-methods"></a>
  Използвайте празни редове между дефиницията на методи, и също да се разбиват методите
  в логически параграфи вътрешно.
...
* <a name="no-trailing-params-comma"></a>
  ...
  Избягвайте запетая след последния параметър в извикване на метод, особено когато
  параметрите не са на отделни редове.
<sup>[[link](#no-trailing-params-comma)]</sup>

  ```Ruby
  # лош - по-лесно е да се мести/добавя/премава параметър, но пак не е препоръчително
  some_method(
               size,
               count,
               color,
...
* <a name="spaces-around-equals"></a>
  Използвайте пространство около оператора `=` при присвояване на стойности по
  подразбиране за параметри на методи:
<sup>[[link](#spaces-around-equals)]</sup>
  ...
  Докато няколко Руби книги предполагат първият стил, а вторият е много
  по-виден в практиката (и може би малко по-разбираемо).

* <a name="no-trailing-backslash"></a>
  Избягвайте продължението на ред `\` къдете не е изисквано. На практика,
  избягвайте продължението на ред за всичко освен конкатенация на низове.
<sup>[[link](#no-trailing-backslash)]</sup>
  ...
  # добър (но все още дяволски грозно)
  result = 1 \
           - 2
...
* <a name="consistent-multi-line-chains"></a>
    Използвайте консистентен многоредови метод стил. Има два
    популярни стила в Руби обществото, и двата от които са считани
    добри - водеща `.` (Опция A) и плаваща `.` (Опция B).
<sup>[[link](#consistent-multi-line-chains)]</sup>

  * **(Опция A)** Когато продължавате верижното извикване на методи на
    друг ред, оставяйте `.` на следващия ред.

    ```Ruby
    # лош - трябва да се види първия ред, за да се разбере втория
    one.two.three.
      four

    # добро - веднага е ясно какво се случва на втория ред
    one.two.three
      .four
    ```

  * **(Опция B)** Когато продължавате верижното извикване на методи на друг ред,
    включвайте `.` на първия ред, за да индикира, че
    израза продължава.

    ```Ruby
    # лош - трябва да четем напред към втория ред, за да знаем, че веригата продължава
    one.two.three
      .four

    # добър - веднага става ясно, че израза продължава отвъд първия ред
    one.two.three.
      four
    ```

  Дискусия върху бонусите и на двата алтернативни стила може да бъде намерен 
  [тук](https://github.com/bbatsov/ruby-style-guide/pull/176).

* <a name="no-double-indent"></a>
    Подреждането на параметрите при извикване на метод, ако те обхващат повече от един
    ред. При центроване на параметри не е подходящо поради ред-дължина
    ограничения, единично идентиране за линиите след първата е също
    приемливо.
<sup>[[link](#no-double-indent)]</sup>

  ```Ruby
  # отправна точка (линията е твърде дълга)
  def send_mail(source)
    Mailer.deliver(to: 'bob@example.com', from: 'us@example.com', subject: 'Important message', body: source.text)
  end

  # лош (двойно идентиране)
  def send_mail(source)
    Mailer.deliver(
        to: 'bob@example.com',
        from: 'us@example.com',
...
* <a name="align-multiline-arrays"></a>
  Подреждайте елементите на масил продължаващ на много редове.
<sup>[[link](#align-multiline-arrays)]</sup>

  ```Ruby
  # лош - единично идентиране
...
* <a name="underscores-in-numerics"></a>
  Добавяйте подчертавки към дълги числови изрази, за да се подобри четимостта.
<sup>[[link](#underscores-in-numerics)]</sup>

  ```Ruby
  # лош - колко много 0 има?
  num = 1000000

  # добър - много по-добър за възприятие от човешкия мозък
  num = 1_000_000
  ```

* <a name="octal-literals"></a>
  Използвайте `0o` за осмични числови изрази вместо `0` или `0O`.
<sup>[[link](#octal-literals)]</sup>
  ...
  # лош - трудно е да се различи нула и голямо-О
  num = 0O1234

  # добър - лесно е да се разпознават цифри от префикса
  num = 0o1234
  ```

* <a name="rdoc-conventions"></a>
    Използвайте [Rdoc][rdoc] и неговивите конвенции за документация на интерфейс.
    Не слагайте празен ред между закоментиращите редове и `def`.
<sup>[[link](#rdoc-conventions)]</sup>

* <a name="80-character-limits"></a>
  Ограничавайте редовете до 80 символа.
<sup>[[link](#80-character-limits)]</sup>

* <a name="no-trailing-whitespace"></a>
  Избягвайте плаващите празни интервали.
<sup>[[link](#no-trailing-whitespace)]</sup>

* <a name="newline-eof"></a>
  Завършвайте всеки документ на нов ред.
<sup>[[link](#newline-eof)]</sup>

* <a name="no-block-comments"></a>
    Не използвайте блокови коментари. Те не могат да бъдат предшествани от интервали
    и не са лесни за виждане като нормалните коментари.
...
* <a name="double-colons"></a>
    Използвайте `::` само за извикването на константи (това включва класове и
    модули) и конструктори (като `Array()` или `Nokogiri::HTML()`).
    Не използвайте `::` за обикновено извикване на метод.
...
* <a name="method-parens"></a>
    Използвайте `def` със скоби когато има параметри. Пропускайте
    скобите когато метода не приема никакви параметри.
...
* <a name="optional-arguments"></a>
    ...
    Дефиниране на опционални аргументи в края на списъка от аргументи.
    Руби има някои неочаквани резултати, когато се извикват методи, които имат
    вариатичен брой аргументи в предната част на списъка.
...
* <a name="parallel-assignment"></a>
    Избягвайте използването на паралелна присвояване за дефиниране на променливи.
    Парелното присвояване се допуска, когато това е резултата от извикване на метод,
    използван с оператора звезда(`*`), или когато се използва, за да се смени промени
    присвояването на променливата. Паралелното присвояване е по-нечетимо от отделно
    присвояване.
<sup>[[link](#parallel-assignment)]</sup>
  ...
  # добър - размяна на променливи с присвояване
  # Размяна на променливи с присвояване е специален случай, понежи ти позволява да
  # размениш стойностите на променливете, присвоени към всяка от тях.
  a = 'foo'
  b = 'bar'
...
* <a name="trailing-underscore-variables"></a>
  Избягвайте използването на ненужни плаващи подчертавка променлива(`_`) по време на
  паралелно присвояване. Именовани подчертани променливи(`_named`) са за предпочитане
  пред подчертавка променлива, заради контекста, който те предоставят.
  Плаваща подчертавка променливи(`named_`) са необходими, когато има звезда променлива
  дефинирана в лявата част на присвояването, и променливата звезда не е подчертавка.
<sup>[[link]](#trailing-underscore-variables)</sup>

  ```Ruby
  # лош
  foo = 'one,two,three,four,five'
  # Ненужно присвояване не предлага никаква полезна информация
  ...
  # добър
  foo = 'one,two,three,four,five'
  # Долната черта е нужда, за да се покаже, че искаш всички елементи
  # освен за последния номер от подчертани елементи
  *beginning, _ = foo.split(',')
  *beginning, something, _ = foo.split(',')

  a, = foo.split(',')
  a, b, = foo.split(',')
  # Ненужно присвояване на не използвани променливи, но присвояването
  # ни предлага много повече информация.
...
* <a name="no-for-loops"></a>
    Не използвайте `for`, освен ако не знаете точно защо. През повечето от времето
    итератори трябва да бъдат използвани. `For` се прилага по отношение на `each`
    (така добавяте ниво на недиректност), но с обрат - `for` не въвежда нов обсег
    (за разлика от `each`) и дефинирани променливи ще се виждат извин неговия обсег.
<sup>[[link](#no-for-loops)]</sup>
  ...
  # отбележете, че elem е достъпен извън `for` цикъла.
  elem # => 3

  # добър
  arr.each { |elem| puts elem }

  # elem не е достъпен извън `each` блока.
  elem # => NameError: undefined local variable or method `elem'
  ```

* <a name="no-then"></a>
  Не използвайте `then` за многоредов`if/unless`.
...
* <a name="same-line-condition"></a>
  Винаги слагайте условието на същия ред като `if`/`unless` в
  многоредови условия.
...
* <a name="ternary-operator"></a>
  Предпочитайте тернарния оператор (`?:`) пред `if/then/else/end` конструкции.
  Това е много по-често и очевидно по ясно.
...
* <a name="no-nested-ternary"></a>
  Използвайте един израз на клон на тернарния оператор. Това
  също така означава, че тернарния оператор не трябва да бъде влаган.
  Предпочитайте `if/else` конструкции в тези случаи.
...
* <a name="no-semicolon-ifs"></a>
  Не използвайте `if x; ...`. Вместо това използвайте
  тернарния оператор.
...
* <a name="use-if-case-returns"></a>
  Възползвайте се от факта, че `if` и `case` са изрази, които връщат стойност.
...
* <a name="one-line-cases"></a>
  Използвайте `when x then ...` за едноредови случаи. Алтернативния синтаксис `when x:
  ...` е премахнат с Руби 1.9.
<sup>[[link](#one-line-cases)]</sup>

* <a name="no-when-semicolons"></a>
  Не ползвайте `when x; ...`. Вижте предишното правило.
<sup>[[link](#no-when-semicolons)]</sup>

* <a name="bang-not-not"></a>
  Използвайте `!` вместо `not`.
<sup>[[link](#bang-not-not)]</sup>

  ```Ruby
  # лош - скобите са задължителни заради предимството
  x = (not something)
...
<sup>[[link](#no-bang-bang)]</sup>
  ...
  x = false
  # двойно отрицание е безполезно върху булеви променливи
  !!x # => false
...
* <a name="no-and-or-or"></a>
  Ключовите думи `and` и `or` са забранени. Просто не си заслужава. Винаги
  ползвайте `&&` и `||` вместо това.
...
* <a name="no-multiline-ternary"></a>
  Избягвайте многоредов  `?:` (тернарния оператор); използвайте `if/unless`
  вместо това.
<sup>[[link](#no-multiline-ternary)]</sup>

* <a name="if-as-a-modifier"></a>
  Предпочитайте модификатор `if/unless` когато имате едноредово тяло. Друга
  добра алтернатива е контрол на потока `&&/||`.
...
* <a name="no-multiline-if-modifiers"></a>
  Избягвайте модификатор `if/unless` в края на нетривални многоредови блокове.
<sup>[[link](#no-multiline-if-modifiers)]</sup>

  ```Ruby
  # лош
  10.times do
    # многоредово тяло пропуснато
