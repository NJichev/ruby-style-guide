...
стилът има значение. Също така смятам, че велико общество хакери, които Руби
има, би трябвало да може сами да си напишат такъв документ.

Това ръководство започна живота си със нашите вътрешни Руби правила във работата
за писане на код(написани от моя милост). В един момент реших, че работата, 
която правех, може да е интересно за членовете на Руби общността, 
по принцип и като цяло, свeтa има малка нужда от други вътрешни фирмени правила.
Но света със сигурност може да се възползва от една общност задвижвани и санкционирани
...
изключителното Руби общество по целия свят. Благодаря за всички предложения
...
Това Руби ръководство по стил препоръчва най-добре практики, така че
в реалния свят Руби програмисти да могат да пишат код лесно поддържан от
...
които би трябвало да помога, рискува да не бъде използвано изобщо - нямайки значение,
колко е добрo.
...
Не съм измислим всички тези правила от никъде - повечето са базирани
на обширната ми кариера като професионален софтуерен инженер,
обратна връзка и предложения от членове на Руби общността и
различни високо ценени програмни Руби ресурси, като например
...
на хеш литерали, точка позицията в многоредови методи и т.н.). При такива сценарии
...
проекто-специфични правила приемат предимсто за проекта.

Можете да генерирате PDF или HTML копие от това ръководство, като използвате
[Pandoc][].

[RuboCop][] е код анализатор, основаващ се на този стил.
